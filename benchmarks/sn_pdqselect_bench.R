# Sn pdqselect regression benchmark
#
# Compares sn() before and after adaptive lowmedian dispatch.
# Also compares against robustbase::Sn as an external reference.
#
# Gates:
...
for (i in seq_along(sizes)) {
  ...
  bm <- bench::mark(sn(x), min_iterations = n_iter, memory = FALSE)
