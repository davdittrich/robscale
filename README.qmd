...
m_speedup_min <- format_speedup(min(m_analyzed$median_speedup))
m_speedup_max <- format_speedup(max(m_analyzed$median_speedup))
...
v_analyzed <- benchmark_report$analyzed$fast_slow
