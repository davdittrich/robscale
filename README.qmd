...
selection algorithms, stack-allocated memory arenas, Aitken $\Delta^2$ acceleration
for M-estimator convergence, and Intel TBB parallelism for large datasets.
...
$\Delta^2$ (Aitken, 1926; Steffensen, 1933) extrapolates from successive iterates $(s_0, s_1,
...
Steffensen, J.F. (1933). Remarks on iteration.
*Skandinavisk Aktuarietidskrift*, **16**, 64--72.
